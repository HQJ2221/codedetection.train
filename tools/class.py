...
def parse_args():
    ...
    parser.add_argument('--image_folder', type=str, default=None, help='Folder with images to classify')
    parser.add_argument('--gt_file', type=str, default=None, help='Path to ground truth txt file')
